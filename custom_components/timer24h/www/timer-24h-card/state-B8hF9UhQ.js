 ...
 */
const H = globalThis, D = H.ShadowRoot && (H.ShadyCSS === void 0 || H.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, z = Symbol(), B = /* @__PURE__ */ new WeakMap();
let X = class {
  constructor(t, e, s) {
...
const it = (r) => new X(typeof r == "string" ? r : r + "", void 0, z), xt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: nt, defineProperty: ot, getOwnPropertyDescriptor: ht, getOwnPropertyNames: at, getOwnPropertySymbols: lt, getPrototypeOf: ct } = Object, f = globalThis, V = f.trustedTypes, dt = V ? V.emptyScript : "", pt = f.reactiveElementPolyfillSupport, b = (r, t) => r, N = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? dt : null;
      break;
  ...
  return e;
} }, L = (r, t) => !nt(r, t), W = { attribute: !0, type: String, converter: N, reflect: !1, useDefault: !1, hasChanged: L };
...
let g = class extends HTMLElement {
  ...
  requestUpdate(t, e, s) {
    if (t !== void 0) {
      ...
      if (s ?? (s = i.getPropertyOptions(t)), !((s.hasChanged ?? L)(n, e) || s.useDefault && s.reflect && n === this._$Ej?.get(t) && !this.hasAttribute(i._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[b("elementProperties")] = /* @__PURE__ */ new Map(), g[b("finalized")] = /* @__PURE__ */ new Map(), pt?.({ ReactiveElement: g }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w = globalThis, R = w.trustedTypes, J = R ? R.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, Y = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, tt = "?" + _, ut = `<${tt}>`, y = document, P = () => y.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", I = Array.isArray, $t = (r) => I(r) || typeof r?.[Symbol.iterator] == "function", j = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K = /-->/g, Z = />/g, A = RegExp(`>|${j}(?:([^\\s"'>=/]+)(${j}*=${j}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), F = /'/g, G = /"/g, et = /^(?:script|style|textarea|title)$/i, _t = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), Mt = _t(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Q = /* @__PURE__ */ new WeakMap(), m = y.createTreeWalker(y, 129);
function st(r, t) {
...
const ft = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === S ? p[1] === "!--" ? o = K : p[1] !== void 0 ? o = Z : p[2] !== void 0 ? (et.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = A) : p[3] !== void 0 && (o = A) : o === A ? p[0] === ">" ? (o = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? A : p[3] === '"' ? G : F) : o === G || o === F ? o = A : o === K || o === Z ? o = S : (o = A, i = void 0);
    const $ = o === A && r[a + 1].startsWith("/>") ? " " : "";
    n += o === S ? h + ut : l >= 0 ? (s.push(c), h.slice(0, l) + Y + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(Y)) {
          ...
          h.push({ type: 1, index: n, name: M[2], strings: $, ctor: M[1] === "." ? mt : M[1] === "?" ? yt : M[1] === "@" ? gt : k }), i.removeAttribute(l);
...
class At {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2 ? c = new O(n, n.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(n, h.name, h.strings, this, t) : h.type === 6 && (c = new vt(n, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class O {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), U(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== v && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : $t(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class k {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = E(this, t, e, 0), o = !U(t) || t !== this._$AH && t !== v, o && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = E(this, a[s + h], e, h), c === v && (c = this._$AH[h]), o || (o = !U(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
Et?.(x, O), (w.litHtmlVersions ?? (w.litHtmlVersions = [])).push("3.3.1");
const St = (r, t, e) => {
...
T._$litElement$ = !0, T.finalized = !0, C.litElementHydrateSupport?.({ LitElement: T });
const bt = C.litElementPolyfillSupport;
bt?.({ LitElement: T });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wt = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: L }, Ct = (r = wt, t, e) => {
...
//# sourceMappingURL=state-B8hF9UhQ.js.map
