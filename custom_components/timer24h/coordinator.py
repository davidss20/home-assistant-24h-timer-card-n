...
from .models import Schedule, ScheduleState
...
class Timer24HCoordinator:
    ...
    def _get_current_slot_index(self, now: datetime | None = None) -> int:
    ...
    def _get_next_slot_time(self, now: datetime | None = None) -> datetime:
